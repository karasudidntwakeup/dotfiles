...
var primary_light = "{{colors.primary.light.hex}}"

var on_primary_light = "{{colors.on_primary.light.hex}}"

var primary_container_light = "{{colors.primary_container.light.hex}}"

var on_primary_container_light = "{{colors.on_primary_container.light.hex}}"

var inverse_primary_light = "{{colors.inverse_primary.light.hex}}"

var primary_fixed_light = "{{colors.primary_fixed.light.hex}}"

var primary_fixed_dim_light = "{{colors.primary_fixed_dim.light.hex}}"

var on_primary_fixed_light = "{{colors.on_primary_fixed.light.hex}}"

var on_primary_fixed_variant_light = "{{colors.on_primary_fixed_variant.light.hex}}"

var secondary_light = "{{colors.secondary.light.hex}}"

var on_secondary_light = "{{colors.on_secondary.light.hex}}"

var secondary_container_light = "{{colors.secondary_container.light.hex}}"

var on_secondary_container_light = "{{colors.on_secondary_container.light.hex}}"
...
var on_secondary_fixed_light = "{{colors.on_secondary_fixed.light.hex}}"

var on_secondary_fixed_variant_light = "{{colors.on_secondary_fixed_variant.light.hex}}"

var tertiary_light = "{{colors.tertiary.light.hex}}"

var on_tertiary_light = "{{colors.on_tertiary.light.hex}}"

var tertiary_container_light = "{{colors.tertiary_container.light.hex}}"

var on_tertiary_container_light = "{{colors.on_tertiary_container.light.hex}}"

var tertiary_fixed_light = "{{colors.tertiary_fixed.light.hex}}"

var tertiary_fixed_dim_light = "{{colors.tertiary_fixed_dim.light.hex}}"

var on_tertiary_fixed_light = "{{colors.on_tertiary_fixed.light.hex}}"

var on_tertiary_fixed_variant_light = "{{colors.on_tertiary_fixed_variant.light.hex}}"

var error_light = "{{colors.error.light.hex}}"

var on_error_light = "{{colors.on_error.light.hex}}"

var error_container_light = "{{colors.error_container.light.hex}}"

var on_error_container_light = "{{colors.on_error_container.light.hex}}"

var background_light = "{{colors.background.light.hex}}"

var on_background_light = "{{colors.on_background.light.hex}}"

var surface_light = "{{colors.surface.light.hex}}"

var on_surface_light = "{{colors.on_surface.light.hex}}"

var surface_variant_light = "{{colors.surface_variant.light.hex}}"

var on_surface_variant_light = "{{colors.on_surface_variant.light.hex}}"

var surface_dim_light = "{{colors.surface_dim.light.hex}}"

var surface_bright_light = "{{colors.surface_bright.light.hex}}"

var surface_tint_light = "{{colors.surface_tint.light.hex}}"

var inverse_surface_light = "{{colors.inverse_surface.light.hex}}"

var inverse_on_surface_light = "{{colors.inverse_on_surface.light.hex}}"

var outline_light = "{{colors.outline.light.hex}}"

var outline_variant_light = "{{colors.outline_variant.light.hex}}"

var scrim_light = "{{colors.scrim.light.hex}}"

var shadow_light = "{{colors.shadow.light.hex}}"

var source_light = "{{colors.source_color.light.hex}}"

var surface_container_lowest_light = "{{colors.surface_container_lowest.light.hex}}"

var surface_container_low_light = "{{colors.surface_container_low.light.hex}}"

var surface_container_light = "{{colors.surface_container.light.hex}}"

var surface_container_high_light = "{{colors.surface_container_high.light.hex}}"
